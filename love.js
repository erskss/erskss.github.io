const phrases = [
    "Прости меня❤️", "Я хочу тебе кое что сказать", "У меня есть разговор", "Незнаю как ты отнесешься к этому", 
    "Давай не сдавайся, нажимай, оно того стоит", "Обещаю последний раз", "А ведь", 
    "Просто хотел сказать", "Что ты дорогой человек для меня ❤️", "Давай помиримся? Мне надо с тобой поговорить","Я дурак,все осознал","Я все обдумал","И хочу сказать и спросить", "Готова?",
];
